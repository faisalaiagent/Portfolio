...
export const siteConfig = {
  ...
  whatsapp: "https://api.whatsapp.com/send?phone=923100122738",
  calendly: "https://calendly.com/faisalagentai",
...
export const projects = [
  ...
  {
    id: "creator-hub",
    title: "Creator Hub AI",
    description:
      "All-in-one AI toolkit for content creators featuring thumbnail analysis, caption generation, hashtag creation, transcript summarization, title generation, hook creation, and content optimization tools.",
    longDescription:
      "Creator Hub AI is a comprehensive creator productivity platform designed to help YouTubers, influencers, marketers, and content creators produce better content faster. The platform combines multiple AI-powered tools into a single dashboard, including thumbnail analysis, viral title generation, caption writing, hashtag suggestions, transcript summarization, content ideation, and engagement optimization. Built to streamline the content creation workflow, Creator Hub AI enables creators to save time, improve content performance, and grow their audience more effectively.",
    tags: [
      "Next.js",
      "TypeScript",
      "Tailwind CSS",
  ...
  },
  {
    ...
    title: "SnapCut AI",
    description:
      "AI-powered image editing tool that removes backgrounds in seconds, enhances photos, and creates professional-quality transparent images for creators, marketers, and e-commerce businesses.",
    longDescription:
      "SnapCut AI is an intelligent image processing platform designed to simplify photo editing through artificial intelligence. Users can instantly remove backgrounds, generate clean transparent PNGs, optimize product photos, and create professional visuals without advanced design skills. Built for content creators, online sellers, marketers, and designers, SnapCut AI combines speed, accuracy, and a modern user experience to streamline image editing workflows and boost productivity.",
    tags: [
      "Next.js",
      "TypeScript",
      "Tailwind CSS",
    ...
    github: "https://github.com/faisalaiagent/Snapcut-AI",
    demo: "https://snapcut-shah.vercel.app/",
    featured: true,
    color: "#F97316",
  },
  {
