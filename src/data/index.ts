...
export const projects = [
  ...
  {
    id: "cod-killer-shopify",
    title: "COD Killer Shopify SaaS",
    description:
      "Shopify app that dramatically reduces cash-on-delivery order cancellations using AI-powered customer verification and automated follow-up flows.",
    longDescription:
      "A specialized Shopify SaaS that cuts COD returns by 60%+ using predictive AI, SMS verification, and automated customer engagement flows.",
    tags: ["Shopify", "Node.js", "Twilio", "MongoDB", "ML"],
    category: "Shopify",
